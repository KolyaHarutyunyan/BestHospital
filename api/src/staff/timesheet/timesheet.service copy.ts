...
export class TimesheetService {
  ...
  async getTotalAmount(
    ...
    if (!overtime.length) {
      ...
      console.log(
        bigAmount,
        'bigAmountbigAmountbigAmountbigAmountbigAmountbigAmountbigAmountbigAmountbigAmountbigAmount',
      );
  ...
  async dailyTimesheet(
    ...
    if (getDayTimesheet.length == [] && dto.hours <= maxMultiplier.threshold) {
      ...
      return await this.getTotalAmount(
        payCode,
        filteredDays,
        dto,
        bigAmount,
    ...
    if (dailyAmount <= maxMultiplier.threshold) {
      ...
      if (dailyAmount >= maxMultiplier.threshold) {
        difference =
          dto.hours >= maxMultiplier.threshold
            ? dto.hours - (dto.hours - maxMultiplier.threshold)
            : dto.hours;
