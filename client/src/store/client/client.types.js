...
/**get client Availability Schedule */
export const GET_CLIENT_AVAILABILITY_SCHEDULE = 'GET_CLIENT_AVAILABILITY_SCHEDULE';
export const GET_CLIENT_AVAILABILITY_SCHEDULE_SUCCESS = 'GET_CLIENT_AVAILABILITY_SCHEDULE_SUCCESS';
