...
import {
    LOG_IN, LOG_IN_SUCCESS, LOG_OUT, GET_RECOVERY_LINK, RESET_PASSWORD_REQUEST, RESET_PASSWORD_SUCCESS,
    CHANGE_PASSWORD_REQUEST, GET_MY_AUTHN, GET_MY_PROFILE, GET_ACCESS, GET_ACCESS_SUCCESS, ASSIGN_ACCESS, REMOVE_ACCESS
} from './auth.types';
...
function* resetPassword(action) {
    ...
    try {
        ...
        yield put(httpRequestsOnErrorsActions.appendError(action.type, err.message));
        yield put(httpRequestsOnSuccessActions.removeSuccess(action.type))
        yield put(httpRequestsOnLoadActions.removeLoading(action.type));
    }
}
