...
export const systemService = {
    ...
    getServicesService: () => axios.get(`/service`, {auth:true}),

    editServiceByIdGlobalService: (id, body) => axios.patch(`/service/${id}`, body, {auth:true}),
    ...
    editJobByIdGlobalService: (id, body) => axios.patch(`/job/${id}`, body, {auth:true}),
