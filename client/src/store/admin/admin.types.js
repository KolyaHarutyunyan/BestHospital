...
export const EDIT_CREDENTIAL_BY_ID_SUCCESS = 'EDIT_CREDENTIAL_BY_ID_SUCCESS'

/**Remove Credential by id */
export const DELETE_CREDENTIAL_BY_ID = 'DELETE_CREDENTIAL_BY_ID'
export const DELETE_CREDENTIAL_BY_ID_SUCCESS = 'DELETE_CREDENTIAL_BY_ID_SUCCESS'
...
export const CLEAR_ALL_PAYCODES = 'CLEAR_ALL_PAYCODES'
export const GET_ALL_PAYCODES_SUCCESS = 'GET_ALL_PAYCODES_SUCCESS'
export const GET_ALL_PAYCODES_FAIL = 'GET_ALL_PAYCODES_FAIL'
