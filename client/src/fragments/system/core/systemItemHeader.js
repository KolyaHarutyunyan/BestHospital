...
export const SystemItemHeader = ({
   ...
   const success =
      httpOnSuccess.length && httpOnSuccess[0].type === "DELETE_SERVICE_BY_ID_GLOBAL"
         ? true
         : httpOnSuccess.length &&
           httpOnSuccess[0].type === "DELETE_CREDENTIAL_BY_ID_GLOBAL"
         ? true
         : httpOnSuccess.length &&
           httpOnSuccess[0].type === "DELETE_DEPARTMENT_BY_ID_GLOBAL"
         ? true
   ...
   const loader =
      httpOnLoad.length && httpOnLoad[0] === "DELETE_SERVICE_BY_ID_GLOBAL"
         ? true
         : httpOnLoad[0] === "EDIT_CREDENTIAL_BY_ID_GLOBAL"
         ? true
         : httpOnLoad[0] === "DELETE_CREDENTIAL_BY_ID_GLOBAL"
         ? true
         : httpOnLoad[0] === "DELETE_DEPARTMENT_BY_ID_GLOBAL"
         ? true
