import { CreateWrapperHead, CustomizedSwitch, InfoWrapper } from "@eachbase/components";
            ...
            head={
               <CreateWrapperHead>
                  <div className={globalStyle.spaceBetween}>
                     ...
                     <div className={globalStyle.centerItem}>
                        <span className={globalText.smallSwitchText}>
                           {switchBoolean === true ? "Inactivate" : "Activate"}
                        </span>
                        <CustomizedSwitch
