...
export const CreateEvent = ({handleOpenClose, date, clientList, staffList, places, allPaycodes, screen, modalDate, createModalType, createModalDate

}) => {
    const classes = scheduleModalsStyle()
    const global = modalsStyle()
    const [screenType, setScreenType] = useState(screen ? screen : createModalType ? createModalType : '')
