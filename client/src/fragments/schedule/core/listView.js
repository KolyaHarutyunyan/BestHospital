                            ...
                            ? (
                                ...
                                <>
                                 ...
                                 {moment(defItem.startDate).format("MMM DD, YYYY")}
                                    ...
                                    {`${moment(defItem.startDate).format("hh:mm A")} - ${moment(
                                        defItem.endTime
                                    ).format("hh:mm A")}`}
                                 </span>
                              </span>
                                    ...
                                    <div className={classes.itemsWrap}>
                                        ...
                                        {defItem && defItem.authorizedService && (
                                            <Items text={"Authorized Service:"} subText={
                                                defItem.authorizedService.modifiers && defItem.authorizedService.modifiers.map((i) => i.name)
                                            }/>
                                        )}
                                        ...
                                        {defItem && defItem.placeService && (
                                            <Items text={"Place of Service:"}
                                                   subText={defItem.placeService.name && defItem.placeService.name}/>
                                        )}
                                    </div>
