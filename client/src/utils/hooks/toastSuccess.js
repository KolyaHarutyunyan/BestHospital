export const ToastSuccess = (success) => {
   if (success) {
      return success === "CREATE_PAYCODE_GLOBAL"
         ...
         ? "Successfully deleted credential settings"
         : success === "DELETE_DEPARTMENT_BY_ID_GLOBAL"
         ? "Successfully deleted department settings"
         : success === "EDIT_CREDENTIAL_BY_ID_GLOBAL"
         ? "Successfully edited credential settings"
         : success === "DELETE_JOB_BY_ID_GLOBAL"
         ? "Successfully deleted job settings"
         : success === "EDIT_JOB_BY_ID_GLOBAL"
         ? "Successfully edited job settings"
         : success === "EDIT_SERVICE_BY_ID_GLOBAL"
         ? "Successfully edited service settings"
         : success === "EDIT_DEPARTMENT_BY_ID_GLOBAL"
         ? "Successfully edited department settings"
         : success === "CREATE_SERVICE_GLOBAL"
         ? "Successfully added service settings"
         : success === "CREATE_CREDENTIAL_GLOBAL"
         ? "Successfully added credential settings"
         : success === "CREATE_DEPARTMENT_GLOBAL"
         ? "Successfully added department settings"
         : success === "CREATE_JOB_GLOBAL"
         ? "Successfully added job settings"
         : success === "CREATE_CREDENTIAL"
         ? "Successfully added credential"
         : success === "EDIT_CREDENTIAL_BY_ID"
         ? "Successfully edited credential"
         : success === "DELETE_CREDENTIAL_BY_ID"
         ...
         ? "Successfully edited availability schedule"
         : success === "EDIT_FUNDING_SOURCE"
         ? "Successfully edited Funding Source"
         ...
         ? "Successfully edited enrollment"
         ...
         ? "Successfully edited authorization"
         : success === "CREATE_CLIENT_AUTHORIZATION"
         ? "Successfully created authorization"
         ...
         ? "Successfully created employment"
         : success === "EDIT_EMPLOYMENT"
         ? "Successfully edited employment"
         : success === "CREATE_PAY_CODE"
         ? "Successfully created pay code"
         : success === "EDIT_PAY_CODE"
         ? "Successfully edited pay code"
         ...
         ? "Successfully created Mileage"
         : success === "EDIT_MILEAGE"
         ? "Successfully edited Mileage"
         ...
         ? "Successfully created Timesheet"
         : success === "EDIT_PLACE_BY_ID_GLOBAL"
         ? "Successfully edited Place"
         ...
         ? "Appointment status was edited"
         : success === "CHANGE_FUNDING_MODIFIER_STATUS"
         ? "Modifier status was edited"
